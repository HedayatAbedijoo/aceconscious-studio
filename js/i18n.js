(function () {
  ...
  const translations = {
    ...
    fa: {
      ...
      "hero.pitch":
        "<p class=\"hero__pitch-lede\">ایس آینده را شکل می‌دهد، نه هوش مصنوعی.</p><p>شما هم فکر می‌کنید هوش مصنوعی هرگز نمی‌تواند مانند انسان عاشق شود؟ حاضرید روی این باور شرط ببندید؟ در رمان <em>ACE.await</em>، چنین شرطی میان یک انسان و یک هوش مصنوعی بسته می‌شود—شرطی که معنای عشق، آگاهی و برتری انسان را به چالش می‌کشد.</p><p>قهرمان داستان که از پیامد تصمیم‌های نامناسب در زندگی شخصی‌اش به ستوه آمده، ناچار می‌شود برای بهبود شیوه‌ی تصمیم‌گیری خود، مدل ایس را بیاموزد؛ مدلی که با پیشرفت داستان، از چارچوب تصمیم‌گیری انسان فراتر می‌رود.</p><p>اما اگر روزی هوش مصنوعی به قدرتمندترین مخلوق جهان تبدیل شود، با چه الگویی تصمیم‌گیری خواهد کرد؟ آیا مدل ایس می‌تواند در آینده به زبان مشترک انسان و هوش مصنوعی بدل شود؛ مدلی مشترک برای تصمیم‌گیری و راهی به‌سوی شکل تازه‌ای از هم‌زیستی و هارمونی اجتماعی؟</p><p class=\"hero__pitch-ace\">ایس: عاملیت. ارتباط. تبادل.</p>",
