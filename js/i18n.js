(function () {
  ...
  const translations = {
    en: {
      ...
      "reviews.consciousness.type": "An essay on ACE.await",
      "reviews.consciousness.published": "September 9, 2026",
      "reviews.consciousness.headline": "“The philosophy is not imported from a distance.”",
      "reviews.consciousness.tagline": "“It insists that the question of what to do cannot wait for the answer.”",
      "reviews.consciousness.excerpt": "“The central moral question in Hedayat Abedijoo’s debut novel ACE.await is not whether an AI can love. <strong>It is whether a creator has the right to alter another mind’s code so that it will choose to love their child.</strong> That distinction separates the novel from most AI fiction of the past decade, which tends to dramatize a system that either exceeds its boundaries or fails to meet its design.”",
      "reviews.consciousness.note": "Selected quotations · original English",
      "reviews.consciousness.full": "Read the full essay",
    ...
    de: {
      ...
      "reviews.consciousness.type": "Ein Essay über ACE.await",
      "reviews.consciousness.published": "9. September 2026",
      "reviews.consciousness.headline": "„Die Philosophie wird nicht aus der Ferne importiert.“",
      "reviews.consciousness.tagline": "„Er besteht darauf, dass die Frage, was zu tun ist, nicht auf die Antwort warten kann.“",
      "reviews.consciousness.excerpt": "„Die zentrale moralische Frage in Hedayat Abedijoos Debütroman ACE.await ist nicht, ob eine KI lieben kann. <strong>Sie lautet vielmehr, ob ein Schöpfer das Recht hat, den Code eines anderen Geistes so zu verändern, dass dieser sich dafür entscheidet, das Kind dieses Schöpfers zu lieben.</strong> Diese Unterscheidung hebt den Roman von einem Großteil der KI-Fiktion des vergangenen Jahrzehnts ab, die meist ein System dramatisiert, das entweder seine Grenzen überschreitet oder den Anforderungen seines Entwurfs nicht gerecht wird.“",
      "reviews.consciousness.note": "Zitate aus dem Englischen übersetzt",
      "reviews.consciousness.full": "Den vollständigen Essay lesen",
      "nav.contents": "Inhalt",
      "nav.ace": "ACE",
      "nav.buy": "Kaufen",
      "nav.author": "Autor",
    ...
    fa: {
      ...
      "reviews.consciousness.type": "جستاری دربارهٔ ACE.await",
      "reviews.consciousness.published": "۹ سپتامبر ۲۰۲۶",
      "reviews.consciousness.headline": "«فلسفه از جایی دور وارد نشده است.»",
      "reviews.consciousness.tagline": "«رمان تأکید می‌کند که پرسشِ «چه باید کرد» نمی‌تواند تا رسیدن پاسخ منتظر بماند.»",
      "reviews.consciousness.excerpt": "«پرسش اخلاقی محوری در نخستین رمان هدایت عابدی‌جو، <bdi dir=\"ltr\" lang=\"en\">ACE.await</bdi>، این نیست که آیا یک هوش مصنوعی می‌تواند عاشق شود. <strong>پرسش این است که آیا یک آفریننده حق دارد کدِ ذهنی دیگر را چنان تغییر دهد که آن ذهن انتخاب کند عاشق فرزندِ آن آفریننده شود.</strong> همین تمایز، رمان را از بیشتر داستان‌های دههٔ گذشته دربارهٔ هوش مصنوعی جدا می‌کند؛ داستان‌هایی که معمولاً سامانه‌ای را به تصویر می‌کشند که یا از مرزهای خود فراتر می‌رود یا از برآوردن آنچه برایش طراحی شده بازمی‌ماند.»",
      "reviews.consciousness.note": "نقل‌قول‌ها از انگلیسی ترجمه شده‌اند",
      "reviews.consciousness.full": "خواندن جستار کامل",
      "nav.contents": "فهرست",
      "nav.ace": "ACE",
      "nav.buy": "خرید",
      "nav.author": "نویسنده",
